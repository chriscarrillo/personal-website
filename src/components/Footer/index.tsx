      ...
      <Row noGutters>
        <Col className="mx-1">
          <a
            ...
            target="_blank"
          >
            <FaGithub className="social-link" data-testid="socialLink" size={32}>
              GitHub
            </FaGithub>
          </a>
        </Col>
        <Col className="mx-1">
          <a
            ...
            target="_blank"
          >
            <FaLinkedin className="social-link" data-testid="socialLink" size={32}>
              LinkedIn
            </FaLinkedin>
          </a>
        </Col>
        <Col className="mx-1">
          <a
            ...
            target="_blank"
          >
            <FaInstagram className="social-link" data-testid="socialLink" size={32}>
              Instagram
            </FaInstagram>
          </a>
        </Col>
